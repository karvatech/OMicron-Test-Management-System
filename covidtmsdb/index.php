...
<head>
  ...
  <title>OMNICRON Covid-19 Testing Management System</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">OMNICRON Covid19-TMS</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#about">About OMNICRON Coronavirus </a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services">OMNICRON Covid-19 Symptoms</a>
          </li>
          <li class="nav-item">
  ...
  <header class="bg-primary text-white">
    <div class="container text-center">
      <h1>OMNICRON COVID19-TMS</h1>
      <p class="lead">OMNICRON COVID19 - Testing Management System</p>
    </div>
  </header>
